...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab }) => {
  const navItems = [
    ...
    { id: 'tasks', label: 'Tasks (Kanban)', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' },
  ...
  return (
    <aside className="w-64 bg-slate-900 text-slate-300 flex flex-col h-screen fixed left-0 top-0">
      <div className="p-6 flex items-center gap-3">
        <div className="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center font-bold text-white italic">O</div>
      ...
      <div className="p-4 bg-slate-800/50 m-4 rounded-xl border border-slate-700/50">
        ...
        <div className="flex items-center gap-2">
          <img src="https://picsum.photos/32/32" className="rounded-full border border-slate-600" alt="Org" />
          <div className="overflow-hidden">
            <p className="text-sm font-medium text-slate-200 truncate">9T9 Workspace</p>
